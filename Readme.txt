...
их и принимать (при принятии отклика пользователю, оставившему отклик, также должно прийти уведомление).
...
Для выполнения рассылок и задач по расписанию выполняем в разных терминалах команды в последовательности:

1. celery -A prj beat
2. celery -A prj worker --loglevel=INFO --concurrency 1 -P solo